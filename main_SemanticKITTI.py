...
class SemanticKITTI:
    def __init__(self, test_id):
        ...
        self.dataset_path = '/data/zcq19/SemanticKITTI/sequences_0.06'
        ...
        def tf_map(batch_pc, batch_label, batch_pc_idx, batch_cloud_idx):
            ...
            for i in range(cfg.num_layers):
                neighbour_idx = tf.py_func(
                    DP.knn_search, [batch_pc, batch_pc, cfg.k_n], tf.int32)  # 调用DP.knn_search
                ...
                # 调用DP.knn_search
                up_i = tf.py_func(
                    DP.knn_search, [sub_points, batch_pc, 1], tf.int32)
